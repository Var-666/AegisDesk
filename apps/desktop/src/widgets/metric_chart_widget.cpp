...
void MetricChartWidget::SetHistory(const QList<ServiceMetricsSnapshot>& history) const {
    RemoveAllSeries();
...
void MetricChartWidget::Clear(const QString& message) const {
    RemoveAllSeries();
...
void MetricChartWidget::RemoveAllSeries() const {
